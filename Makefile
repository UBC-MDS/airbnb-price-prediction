...
# run all analysis
all: docs/final_report_milestone_2.md docs/final_report_milestone_2.Rmd
...
# render report
docs/final_report_milestone_2.md docs/final_report_milestone_2.Rmd: docs/final_report_milestone_2.Rmd output/neighborhoods.png output/number_of_properties_by_price.png output/price_by_property_type.png output/residual_plot.png output/baseline_results.csv output/optimized_results.csv
...
clean: 
	...
	rm -f output/*.png
	rm -f output/*.csv
	rm -f docs/final_report_milestone_2.md docs/final_report_milestone_2.Rmd